...
public class WebClient {
     ...
     * @throws IOException x
     */
    public String executeString(String url) throws IOException {
        return executeString(builderRequest(url));
    ...
    public String downloadString(String url, Map<String, String> params) {
        try {
            return executeString(builderRequest(url, params));
        } catch (IOException e) {
     ...
     * @return x
     */
    private Request builderRequest(String url, Map<String, String> params) {
     ...
     * @return x
     */
    private Request builderRequest(String url) {
        return builderRequest(url, null);
    }
