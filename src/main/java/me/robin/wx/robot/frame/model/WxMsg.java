...
public class WxMsg {
    ...
    public String toString() {
        return "WxMsg [msgID=" + msgID + ", fromUserName=" + fromUserName + ", content=" + content + ", toUserName=" + toUserName + ", createTime="
            + createTime + ", fileName=" + fileName + ", fileSize=" + fileSize + ", mediaId=" + mediaId + ", msgType=" + msgType + ", url=" + url
            + ", subMsgType=" + subMsgType + ", appMsgType=" + appMsgType + ", recommendInfo=" + recommendInfo + "]";
    }
